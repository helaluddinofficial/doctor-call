-- CreateEnum
CREATE TYPE "public"."UserRole" AS ENUM ('UNASSIGN', 'PATIENT', 'DOCTOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "public"."VerificationStatus" AS ENUM ('PENDING', 'VERIFIED');

-- CreateEnum
CREATE TYPE "public"."SlotStatus" AS ENUM ('AVAILABILITY', 'BOOKED', 'BLOCKED');

-- CreateEnum
CREATE TYPE "public"."AppointmentStatus" AS ENUM ('SCHEDULE', 'COMPLETED', 'CANCELED');

-- CreateEnum
CREATE TYPE "public"."TransactionType" AS ENUM ('ADMIN_ADJUSTMENT', 'APPOINTMENT_DEDUCTION', 'CREDIT_PURCHASE');
...
CREATE TABLE "public"."User" (
    ...
    "name" TEXT,
    "imageUrl" TEXT,
    "role" "public"."UserRole" NOT NULL DEFAULT 'UNASSIGN',
...
CREATE TABLE "public"."Availability" (
    ...
    "status" "public"."SlotStatus" NOT NULL DEFAULT 'AVAILABILITY',
...
CREATE TABLE "public"."Appointment" (
    ...
    "startTime" TIMESTAMP(3) NOT NULL,
    "endTime" TIMESTAMP(3) NOT NULL,
    "status" "public"."AppointmentStatus" NOT NULL DEFAULT 'SCHEDULE',
    "notes" TEXT,
